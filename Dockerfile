...
# TODO: is Python2 also installed to the container? If so, delete that shit
RUN apt install -y python3-pip && apt install -y python-is-python3 && pip install pint && pip install markupsafe==2.0.1
