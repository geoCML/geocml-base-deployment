    ...
    for schema in schemas:
        ...
        for table in tables:
            ...
            if is_raster:
                ...
                out = subprocess.run(f'gdal_translate -sds -of PNG PG:"host=geocml-postgres port=5434 user=postgres password={os.environ["GEOCML_POSTGRES_ADMIN_PASSWORD"]} dbname=geocml_db schema={schema[0]} table={table[2]}" {os.path.join(path_to_backup_dir, "rasters", table[2] + ".png")}', capture_output=True, shell=True)
